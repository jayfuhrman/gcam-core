...
generate_level2_data_names <- function() {
  ...
  level2_data_names[["RsrcCurvesExtCost"]] <- c(level2_data_names[["SubRsrc"]], "grade", "extractioncost")
  level2_data_names[["RsrcCurvesAvail"]] <- c(level2_data_names[["SubRsrc"]], "grade", "available")
