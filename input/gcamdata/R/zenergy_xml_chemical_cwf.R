...
#' module_energy_chemical_cwf_xml
#'
...
module_energy_chemical_cwf_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L2325.SubsectorShrwtFllt_chemical_cwf <- get_data(all_data, "L2325.SubsectorShrwtFllt_chemical_cwf")
    L2325.SubsectorInterp_chemical_cwf <- get_data(all_data, "L2325.SubsectorInterp_chemical_cwf")
    L2325.GlobalTechShrwt_chemical_cwf <- get_data(all_data, "L2325.GlobalTechShrwt_chemical_cwf")
